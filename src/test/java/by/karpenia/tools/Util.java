...
public class Util {
    ...
    public static final String REPOSITORY_SETTINGS_URL = "https://github.com/GitHubTestingProject/TestRepository/settings";
    public static final String DRIVER_PATH = "D:/Katerina_Karpenia/programs/geckodriver-v0.14.0-win64/geckodriver.exe";
    ...
    public static final String LOCATION = "Belarus, Minsk";
    public static final String TOTAL_REPOSITORY_NAME = "GitHubTestingProject/TestRepository";
